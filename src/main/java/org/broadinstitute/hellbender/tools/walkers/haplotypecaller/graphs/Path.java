...
public class Path<V extends BaseVertex, E extends BaseEdge> {
     ...
     */
    public Cigar calculateCigar(final byte[] refSeq, final SmithWatermanAligner aligner, final SWParameters swParameters) {
        //Note: CigarUtils.calculateCigar already checks for null
        return CigarUtils.calculateCigar(refSeq, getBases(), aligner, swParameters, SWOverhangStrategy.SOFTCLIP);
    }
